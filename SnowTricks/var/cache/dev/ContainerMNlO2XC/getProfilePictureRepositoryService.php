...
// Returns the private 'App\Repository\ProfilePictureRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProfilePictureRepository.php';

return $this->privates['App\Repository\ProfilePictureRepository'] = new \App\Repository\ProfilePictureRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
