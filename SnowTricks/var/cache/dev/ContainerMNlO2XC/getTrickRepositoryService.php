...
// Returns the private 'App\Repository\TrickRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrickRepository.php';

return $this->privates['App\Repository\TrickRepository'] = new \App\Repository\TrickRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
