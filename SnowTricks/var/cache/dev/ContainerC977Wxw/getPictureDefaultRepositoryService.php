...
// Returns the private 'App\Repository\PictureDefaultRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PictureDefaultRepository.php';

return $this->privates['App\Repository\PictureDefaultRepository'] = new \App\Repository\PictureDefaultRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
